...
An event is when the values of state variables change abruptly. In most programming environments, 
...
## Example: A patient gets injections of a drug in the blood
...
## Example 2: An event triggered by a root: A bouncing ball
