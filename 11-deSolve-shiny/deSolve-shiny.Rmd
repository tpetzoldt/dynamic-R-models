...
[**this link**](https://weblab01.hydro.tu-dresden.de/tutorials/deSolve-shiny.html) 
...
cat('<iframe src="https://weblab01.hydro.tu-dresden.de/apps/bruss01/" style="border: none; width: 75%; height: 500px" />\n')
```
...
```{r results='asis', echo=FALSE}
cat('<iframe src="https://weblab01.hydro.tu-dresden.de/apps/bruss02/" style="border: none; width: 100%; height: 800px" />\n')
```
...
https://weblab01.hydro.tu-dresden.de/apps/bruss03


<!---
```{r results='asis', brusselator_3}
cat('<iframe src="https://weblab01.hydro.tu-dresden.de/apps/bruss03/" style="border: none; width: 1024px; height: 800px" />\n')
```
--->
...
```{r results='asis', echo=FALSE}
cat('<iframe src="https://weblab01.hydro.tu-dresden.de/apps/bruss04/" style="border: none; width: 100%; height: 800px" />\n')
```
